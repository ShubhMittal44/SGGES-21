...
function myFunction()
{
    ...
    document.querySelector("#pop").innerHTML="<p><b>Dr. Chitra A.</b><br> Associate professor<br>Department of Energy & Power Electronics School of Electrical Engineering<br>VIT Vellore, India<br> E-Mail: chitra.a@vit.ac.in <br>Mobile:+91 9894760447 </p><br>";
}
document.getElementById("b2").addEventListener("click",myFunction1);
function myFunction1()
{
    document.getElementById("pop").className="main4 shadow";
    document.querySelector("#pop").innerHTML="<p><b>Dr. V. Indragandhi </b><br> Associate professor<br>Department of Energy & Power Electronics School of Electrical Engineering<br>VIT Vellore, India<br> E-Mail: indragandhi.v@vit.ac.in <br>Mobile:+91 97506 03539 </p><br>";
}
